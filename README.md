...
## 10. Descripción de Validador de tarjetas de crédito.

Descripción del proyecto: 

La página tiene como función principal invitar al usuario a realizar la validación de una tarjeta de crédito para posteriormente 
realizar un pago con esta misma, aunque el enfoque principal consiste en validar los datos gracias al funcionamiento de comprobación
basado en el algortimo de Luhn.
El código debe lograr identificar si los números ingresados por el usuario son los correctos, en caso contrario la página también 
brindará la información que destaque el fallo en el ingreso de datos, ya sea porque los números son incorrectos o porque los carácteres 
no son los suficientes.


Instrucciones de uso: 

La función principal de la página es lograr validar si la terjeta ingresada en esta cumple con las condiciones del algoritmo anteriormente indicado. 
En el recuadro donde se pueden ingresar solo carácteres numéricos, se debe teclear el número de la tarjeta y posteriormente debemos 
utilizar el botón "Validar" para proseguir. 
Si la numeración coincide con el algoritmo, automáticamente retornará al usuario el mensaje "La tarjeta con número X es válida.". Si la numeración no coincide con el algoritmo retornará al usuario el mensaje "La tarjeta con número X no es válida." 
En última instancia, si el usuario ingresa la numeración pero esta no alcanza a tener 16 carácteres, la página retornará el mensaje 
"El número de tarjeta de crédito debe tener al menos 16 carácteres.".